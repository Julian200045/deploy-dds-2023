  ...
  public static Object controller(String nombre) {
    ...
    switch (nombre) {
      case "Incidentes":
        ...
        break;
      case "Usuarios":
        controller = new UsuariosController(new RepositorioUsuarios(em), new RepositorioRol(em), new RepositorioPersonas(em), new ValidadorDeContraseniasPorValidaciones(), new LectorPropiedades("src/main/resources/template/project.properties"), new HasherEstandar());
        break;
      case "Comunidades":
